...
let mode_State_Run_TimerCountdown_Sec_Int = 0
...
namespace quest_Hardware {
     ...
     */
    //% block="set settings(required in 'on start' stack):|* 'deviceType_Bot_Bool': $deviceTypeBotBoolIn|* 'deviceType_Controller_Bool': $deviceTypeControllerBoolIn"
...
//
/**
 * quest_Autonomous blocks
 */
//% weight=41 color=#008000 icon="Q"
namespace quest_Autonomous {
    ...
    * @param k_i_in number
    */
    //% block="set autonmous_control (turning_offset_int_in: $turning_offset_int_in|timer_countdown_sec_int_in: $timer_countdown_sec_int_in|k_p_in: $k_p_in|k_d_in: $k_d_in|k_i_in: $k_i_in"
    //% turning_offset_int_in.min=0 turning_offset_int_in.max=180
    //% timer_countdown_sec_int_in.min=0 timer_countdown_sec_int_in.max=10
    //% k_p_in.min=0.0 k_p_in.max=0.9
    //% k_d_in.min=0.0 k_d_in.max=0.9
    //% k_i_in.min=0.00 k_i_in.max=0.09
    //% weight=85 blockGap=8
    //% inlineInputMode=external    
    export function rq_Mode_State_Run_PID_Fn(turning_offset_int_in: number, timer_countdown_sec_int_in: number, k_p_in: number, k_d_in: number, k_i_in: number) {
        ...
        if (true) {
            ...
            mode_State_Run_TimerCountdown_Sec_Int = timer_countdown_sec_int_in
        ...
        if (true) {
            // was 20
            motor_PowerAdjust_Stage1_AvoidIdleDeadzone_AsOffset_ForTurnsAndStraights_Int = 12
            motor_PowerAdjust_Stage2_PdiBaseMotion_AsOffset_ForStraights_Int = 20
        }
        do_Set_SensorCompassDirection_Stage01_DetectTarget_Degrees_Int_Fn()
        ...
        if (true) {
            quest_Dashboard.rq_Show_String_For_Oled_SmallFont_Fn(
                "T:" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    sensor_Compass_Direction__Detect_Target__Degrees__Int,
                    3,
                    0
                ) + " -B:" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    ...
                    4,
                    0
                ) + " D:" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
            ...
            quest_Dashboard.rq_Show_String_For_Oled_SmallFont_Fn(
                "Kp" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    sensor_Compass_Direction__Detect_Delta_Now__DegreesToPower__K_Proportional_MagicConvert__Int,
                    4,
                    2
                ) + " Kd" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    sensor_Compass_Direction__Detect_Delta_Change__DegreesToPower__K_Derivative_MagicConvert__Int,
                    4,
                    2
                ) + " Ki" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
            ...
            quest_Dashboard.rq_Show_String_For_Oled_SmallFont_Fn(
                "P:" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    ...
                    5,
                    1
                ) + "  I:" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
            ...
            quest_Dashboard.rq_Show_String_For_Oled_SmallFont_Fn(
                "PDI:" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    sensor_Compass_Direction__Detect_Delta__DegreesToPower__K_Total_Fix__Int,
                    5,
                    1
                ) + " L:" + motor_Direction_Left_Str + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    motor_Power_Left_Int,
                    3,
                    0
                ) + " R:" + motor_Direction_Right_Str + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
            ...
            quest_Dashboard.rq_Show_String_For_Oled_SmallFont_Fn(
                "1_P(" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    sensor_Compass_Direction__Detect_Delta_Now__Degrees__Int,
                    4,
                    0
                ) + "x" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    sensor_Compass_Direction__Detect_Delta_Now__DegreesToPower__K_Proportional_MagicConvert__Int,
                    4,
                    2
                ) + ")=" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
            ...
            quest_Dashboard.rq_Show_String_For_Oled_SmallFont_Fn(
                "2_D(" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
            ...
            quest_Dashboard.rq_Show_String_For_Oled_SmallFont_Fn(
                "3_I(" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
            ...
            quest_Dashboard.rq_Show_String_For_Oled_SmallFont_Fn(
                "Dead:" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    motor_PowerAdjust_Stage1_AvoidIdleDeadzone_AsOffset_ForTurnsAndStraights_Int,
                    2,
                    0
                ) + " Base:" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
                    motor_PowerAdjust_Stage2_PdiBaseMotion_AsOffset_ForStraights_Int,
                    2,
                    0
                ) + " Win:" + quest_Algorithm.rq_Get_Number_WithColumnPadding_AsStringOut_Fn(
    ...
    function do_Set_SensorCompassDirection_Stage01_DetectTarget_Degrees_Int_Fn() {
